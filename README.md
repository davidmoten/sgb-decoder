...
Note that a unit [test](src/test/java/au/gov/amsa/sgb/decoder/internal/JsonSchemaTest.java) confirm that the abovementioned sample json complies with the JSON Schema.
